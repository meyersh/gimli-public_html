...
<body class="index">
  ...
  <div class="box-container manifesto">
	...
	<div class="belief top">
	  <h3>Javascript</h3>
	  <h4><A href="http://gimli.morningside.edu/~meyersh/310/bfs/">Tabular adjacency matrix example</a></h4>
	  <p>As promised in class (and nearly finished) example of Slice 3 Project 2.</p>
	</div>
      </div>
    </div>
	...
	<div class="belief top">
	  ...
	  <p>Source code & Changelog is available for browsing/download 
	    <a href="http://gimli.morningside.edu/~meyersh/gitweb/?p=git;a=summary">here.</a></p>
	</div>
      </div>
    </div>
	...
	<div class="belief top">
	  <h3>News</h3>
	  <h4>Nov/2011</h4>
          <p>Started switching to HTML5 and added some CSS3 goodies. 
	    The page layout is now completely fluid!</p>
	</div>
      </div>
    </div>
